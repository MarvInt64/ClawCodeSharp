...
public class CodeSharpApiClient : IProvider
{
    ...
    public string ProviderName => "CodeSharpApi";
    
    public CodeSharpApiClient(string? apiKey = null, string? oauthToken = null, string? baseUrl = null)
    {
        _apiKey = apiKey ?? Environment.GetEnvironmentVariable("ANTHROPIC_API_KEY");
        _oauthToken = oauthToken;
        _baseUrl = baseUrl ?? Environment.GetEnvironmentVariable("CODESHARP_API_BASE_URL") ?? "https://api.anthropic.com";
        _httpClient = new HttpClient();
    }
    
    public static CodeSharpApiClient FromEnv()
    {
        var apiKey = Environment.GetEnvironmentVariable("ANTHROPIC_API_KEY");
        var oauthToken = Environment.GetEnvironmentVariable("CODESHARP_OAUTH_TOKEN");
        var baseUrl = Environment.GetEnvironmentVariable("CODESHARP_API_BASE_URL");
        
        return new CodeSharpApiClient(apiKey, oauthToken, baseUrl);
    }
