...
public class ArgumentParser
{
        ...
        while (i < args.Length)
        {
            switch (args[i])
            {
                ...
                default:
                    ...
                    {
                        throw new ArgumentException($"Direct slash command '{args[i]}' is not available outside REPL. Start 'claw' to use interactive slash commands.");
                    }
    ...
    {
        "anthropic" => ProviderKind.ClawApi,
